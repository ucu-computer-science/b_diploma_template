...
Ця копія неофіційна. Також, тут писатиму технічні поради своїм дипломникам, накопичені за роки[^SSS]. Оскільки (поки?) всі вони вільно володіють українською, а мені нею писати простіше, ніж англійською, то, на відміну від шаблону, пишу українською. 
...
Не соромтеся додавати нумерацію формул і потім її використовувати! 
...
Дуже важливо, щоб вміст сторінки не вилазив за правий[^LRG] край! Код — переформатуйте. Слова — можна переноси вручну вказати: ``Spil\-ling`` — ``\-`` вказує прийнятну точку переносу для слів, яких сам LaTeX не знає.
