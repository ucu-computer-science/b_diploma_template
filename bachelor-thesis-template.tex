...
% \usepackage{mathpazo} % Use the Palatino font by default % O.F. Breaks Cyr. including Ukrainian
...
\vfill
\includegraphics[height=2.5cm]{apps.png} % University/department logo - uncomment to place it
...
The Thesis Abstract is written here (and usually kept to just this page). The page is kept centered vertically so can expand into the blank space above the title too\ldots Тест кирилиці: ІіЇїҐґ.
\end{abstract}
